      ...
      <div className="overflow-x-hidden  rounded-lg shadow-lg bg-white min-w-full">
        ...
        <div className="p-6">
          <button
            ...
            type="button"
            className="inline-block px-6 py-2.5 mb-0 bg-rose-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out"
          >
            Stock Update
          </button>
        </div>
